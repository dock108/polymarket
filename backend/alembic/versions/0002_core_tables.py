...
def upgrade() -> None:
    ...
    op.create_index("ix_odds_log_event_bookmaker_created", "odds_log", ["event_id", "bookmaker", "created_at"])
    ...
    op.create_index("ix_market_snapshot_source_captured", "market_snapshot", ["source", "captured_at"])
    op.create_index("ix_market_snapshot_event_captured", "market_snapshot", ["event_id", "captured_at"])
